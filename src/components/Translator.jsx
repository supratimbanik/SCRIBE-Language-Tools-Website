/* Component used for Translator tool */
import React, { useState, useEffect } from "react";
import countries from "./util/data-languages.js"; // Contains unique code for all supported languages along with their names
import Navbar from "./util/Navbar";
import Footer from "./util/Footer";
import "./styles/Translator.css";
/* Material UI components for icons */
import SwapHorizIcon from "@mui/icons-material/SwapHoriz";
import VolumeUpIcon from "@mui/icons-material/VolumeUp";
import ContentCopyIcon from "@mui/icons-material/ContentCopy";

function Translator() {
  /* useState hooks for tracking the required states */
  ...
  /* useEffect for selecting language */
  useEffect(() => {
  ...
  /* Function to interghange language */
  ...
  /* Function for translating a language */
